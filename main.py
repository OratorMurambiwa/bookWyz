...
def search():
    ...
    if request.method == 'GET':
        ...
        if response.status_code==200:    #200 means request was successful, 404 means not found; 401 means unauthorized
            data= response.json()
...
root=Tk()
root.title("BookWyz")
root.geometry("1250x800+200+100")
...
#background image
# heading_image=PhotoImage(file="Images/rectangle 5.png")
# Label(root,image=heading_image,bg="#000000").place(x=+400,y=+80)

#logo
logo_image=PhotoImage(file="Images/2299.png")
Label(root,image=logo_image,width=110,height=100,bg="#000000").place(x=400,y=50)

#heading
heading=Label(root,text="BOOKWYZ",font=("Merlin",60,"bold"),fg="white",bg="#000000")
heading.place(x=550,y=50)

#search background image
search_box=PhotoImage(file="Images/search1.png")
Label(root,image=search_box,width=600,height=50, bg="#000000").place(x=405,y=170)

#entry box / search section
Search=StringVar()
search_entry=Entry(root,textvariable=Search,width=15,font=("Lato",25),bg="white",fg="black",bd=0)
search_entry.place(x=500,y=175)

#search button
recommand_button_image=PhotoImage(file="images/5.png")
recommand_button=Button(root,image=recommand_button_image, height=50, bd=0, activebackground="#252532",cursor="hand2",command=search)
recommand_button.place(x=850,y=170)

#setings button
Setting_image=PhotoImage(file="Images/setting.png")
setting=Button(root,image=Setting_image,bd=0,cursor="hand2",activebackground="#000000",bg="#000000",width=50,height=100)
setting.place(x=930,y=145)
...
Button(root,image=Logout_image,bg="#000000",cursor="hand1",command=lambda: root.destroy()).place(x=1150,y=20)
...
#second frame
frame11=Frame(root,width=150,height=50,bg="white")
frame22=Frame(root,width=150,height=50,bg="white")
frame33=Frame(root,width=150,height=50,bg="white")
frame44=Frame(root,width=150,height=50,bg="white")
frame55=Frame(root,width=150,height=50,bg="white")


#published date
text2={'a11':Label(frame11,text="date",font=("arial",10),bg="white"),'a22':Label(frame22,text="date",font=("arial",10),bg="white"),'a33':Label(frame33,text="date",font=("arial",10),bg="white"),'a44':Label(frame44,text="date",font=("arial",10),bg="white"),'a55':Label(frame55,text="date",font=("arial",10),bg="white")}
...
#rating
text3={'a111':Label(frame11,text="rating",font=("arial",10),bg="white"),'a222':Label(frame22,text="rating",font=("arial",10),bg="white"),'a333':Label(frame33,text="rating",font=("arial",10),bg="white"),'a444':Label(frame44,text="rating",font=("arial",10),bg="white"),'a555':Label(frame55,text="rating",font=("arial",10),bg="white")}
